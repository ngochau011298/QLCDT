...
<body>
    <form style="padding-top:30px; " id="form1" runat="server">
        <div class="container">
            <div class="list-group">
                <div style="border-color:darkred; background-color:peachpuff;" class="list-group-item">
                    ...
                    <asp:GridView BorderColor="DarkRed" CssClass="table table-bordered" ID="gvThongTinSuDung" runat="server" AutoGenerateColumns="false">
                        <Columns>
